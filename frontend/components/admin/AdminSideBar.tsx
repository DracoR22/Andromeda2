...
const AdminSideBar = ({ active }: Props) => {
  return (
    ...
    <div className="w-full flex items-center p-4">
      <Link href="/admin/sellers" className="w-full flex items-center">
        <GrWorkshop
          size={30}
    ...
    <div className="w-full flex items-center p-4">
      <Link href="/admin/users" className="w-full flex items-center">
        <HiOutlineUserGroup
          size={30}
    ...
    <div className="w-full flex items-center p-4">
      <Link href="/admin/events" className="w-full flex items-center">
        <MdOutlineLocalOffer
          size={30}
